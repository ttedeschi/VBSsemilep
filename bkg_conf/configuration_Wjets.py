...
cfg = Configurator(
    ...
    datasets = {
        "jsons" : [f"{localdir}/datasets/WtoLNu-2Jets_PTLNu-100to200_2J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8.json"],
        "filter" : {
            "samples" : ["WtoLNu-2Jets_PTLNu-100to200_2J_TuneCP5_13p6TeV_amcatnloFXFX-pythia8"],
        }
    ...
    workflow=VBS_WV_Processor,
     skim = [
            get_nPVgood(1), 
            get_nObj_min_or(
                [skim_dict["Wjets"]["Muon"]["ptMin"],skim_dict["Wjets"]["Electron"]["ptMin"]], 
                [skim_dict["Wjets"]["Muon"]["nMin"], skim_dict["Wjets"]["Electron"]["nMin"]],
                ["Muon", "Electron"]),
            ],
    preselections = [semileptonic_preselW, VBS_jets_presel, Bjets_presel, Vjet_massSide],
    
    categories= {
        "baseline" : [passthrough],
        "SingleEle_AK8_right" : [get_nElectron(1, coll="ElectronGood"), get_nObj_min(1 , coll="CleanFatJet_sideR")],
        "SignelEle_AK8_left" : [get_nElectron(1, coll="ElectronGood"), get_nObj_min(1 , coll="CleanFatJet_sideR")],
        "SingleEle_AK4_right" : 
        "SingleEle_AK8_left" : []
        "SignleMuon_AK8_right"
    },    
