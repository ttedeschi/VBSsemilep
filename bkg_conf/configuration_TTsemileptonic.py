...
cfg = Configurator(
    ...
    datasets = {
        "jsons" : [f"{localdir}/datasets/TTbar/TTtoLNu2Q_HT-500_NJet-9_Hdamp-158_TuneCP5_13p6TeV_powheg-pythia8.json" ],
        "filter" : {
    ...
    preselections=[VBS_jets_presel, semileptonic_preselW, Bjets_presel],
